...
* Request
  * Method: GET
  * URL: /api/users/:artistId/playlists
  * Body: none
...
## Remove a Song from a Playlist based on the Playlists's id

Remove a song from a playlist specified by the playlist's id.
